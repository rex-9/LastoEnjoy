...
const CharacterModal = ({
  ...
  return (
    <>
      <div className="fixed w-screen h-[110%] bg-black bg-opacity-40">
        <div className="fixed top-[20%] left-[40%] bg-gradient-to-tr from-purple-900 via-gray-800 to-orange-600 p-8 rounded-lg">
